...
namespace Okta.Idx.Sdk.UnitTests
{
   ...
   ""error"":""some error message""
    ...
    ""app"": {
        ...
        [Fact]
        public async Task SelectOktaVerifyFactor()
        {
            var identifyResponse = @"{
    ""version"": ""1.0.0"",
    ""stateHandle"": ""021C3ZbZ-XFGFxdlWF4icuOb_OovyI-xncnPS4ebsa"",
    ""expiresAt"": ""2021-12-15T16:25:14.000Z"",
    ""intent"": ""LOGIN"",
    ""remediation"": {
        ""type"": ""array"",
        ""value"": [
            {
                ...
                ""value"": [
                    ...
                    },
                    {
                        ""name"": ""stateHandle"",
                        ""required"": true,
                        ""value"": ""021C3ZbZ-XFGFxdlWF4icuOb_OovyI-xncnPS4ebsa"",
                        ""visible"": false,
                        ""mutable"": false
                    }
                ],
    ...
    ""app"": {
        ...
        ""value"": {
            ...
            var selectOktaVerifyResponse = @"{
    ""version"": ""1.0.0"",
    ""stateHandle"": ""02J71SCAwBFg_1YiXDtMBORA67znRpWy2YZh9p3tys"",
    ""expiresAt"": ""2021-12-10T15:46:39.000Z"",
    ""intent"": ""LOGIN"",
    ""remediation"": {
        ""type"": ""array"",
        ""value"": [
                ...
                ""value"": [
                    {
                        ""name"": ""stateHandle"",
                        ""required"": true,
                        ""value"": ""02J71SCAwBFg_1YiXDtMBORA67znRpWy2YZh9p3tys"",
                        ""visible"": false,
                        ""mutable"": false
                    }
                ],
    ...
    ""currentAuthenticator"": {
        ...
        ""value"": {
            ""contextualData"": {
                ""qrcode"": {
                    ""method"": ""embedded"",
                    ""href"": ""data:image/png;base64,"",
                    ""type"": ""image/png""
                },
    ...
    ""app"": {
        ...
        ""value"": {
            ...
            Queue<MockResponse> queue = new Queue<MockResponse>();
            queue.Enqueue(new MockResponse { StatusCode = 200, Response = identifyResponse });
            queue.Enqueue(new MockResponse { StatusCode = 200, Response = selectOktaVerifyResponse });
            ...
            parameters[1].Label.Should().Be("EMAIL");
            parameters[1].Value.Should().Be("email");
            parameters[2].Label.Should().Be("SMS");
            parameters[2].Value.Should().Be("sms");
        }
